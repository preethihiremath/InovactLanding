  ...
  const styles = useStyles();
    return(
        ...
        <Box className={styles.features} >
          ...
          className={styles.title}>Our Exciting Features</Typography>
            ...
            <Container style={{padding:'0px 20px'}}>
              <Grid className={styles.social}>
                ...
                <Container>
                    <h2
                      className={styles.learningTitle}>Inovact<span style={{ 
                                                                color: '#F94962',
                                                                fontStyle:'italic'}}> Social</span>
                    </h2>
                 ...
                 <Container>
                    <h2
                    className={styles.learningTitle}>
                    Inovact <span style={{color: '#F94962',fontStyle:'italic'}}>learning <span style={{color: '#000'}}>&#38; </span>placements</span></h2>
                          <Grid className={`${styles.grid2}`}>
                              {LEARNING.map((feature) => (
                                <Box
                                className={`${styles.featureCardsL}`}>
                                    <Card className={styles.featureEachCard}>
